...
class BroadcastChannel {
   ...
   *
   * @param event: event name -> should be a valid event name present in BROADCAST_EVENTS
   ...
   *
   * @param event: Event name -> should be a valid event name present in BROADCAST_EVENTS
   * @param target: App name that should receive the event
   * @param data: Data to be passed to target app
   */

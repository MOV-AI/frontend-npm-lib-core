...
export class User {
  ...
  /**
   * Get all apps
   * @returns {Promise} List with all apps
   */
  getAllApps = () => {
  ...
  /**
   * Get allowed apps
   * @returns {Promise<any>} List of allowed apps
   */
   ...
   * @param {ChangePassword} body : Request body
   ...
   * @param {ResetPassword} body : Request body
   * @returns {Promise} Response promise
   */
   ...
   * @returns {UserModel} user : returns the user with permissions dictionaries
   */
   ...
   * @param {PermissionType} operation :  The operation on the scope - "read", "write", "create" or "delete"
   ...
   * @param {UserPost} model : The User Post model
   */
  static create = (model: UserPost) => InternalUser.create(model);

  /**
   * Update a new User
   * @param {string} userId : The User Put model
   * @param {UserPut} model : The User Put model
   */

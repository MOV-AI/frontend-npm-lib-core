...
var WSSub = function WSSub() {
  ...
  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(this, "send", function (message) {
    ...
    try {
      ...
      _this.getState() !== WebSocket.OPEN ? setTimeout(_this.send, _this.RESEND_TIMEOUT, message, retry + 1) : _this.websocket.send(JSON.stringify(message));
    } catch (error) {
      console.error(error);
    }
  });
...
var Document = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Document, null, [{
    ...
    key: "parsePath",
    value: function parsePath(_path) {
      var dtype = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "Node";

      var spl = _path.split("/");

      var workspace = spl.length > 1 ? spl[0] : "global";
      var type = spl[1] || dtype;
      var name = spl[2] || _path;
      var version = spl[3] || "__UNVERSIONED__";
      var path = "".concat(workspace, "/").concat(type, "/").concat(name, "/").concat(version);
      return {
        workspace: workspace,
        type: type,
        name: name,
...
var DocumentV1 = /*#__PURE__*/function () {
  function DocumentV1(_ref) {
    ...
    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "_init", function (type, name, workspace, version, path) {
      _this._parseArgs(workspace, type, name, version, path);
    ...
    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "_parseArgs", function (workspace, type, name, version, path) {
    ...
    this._init(_type2, _name2, _workspace2, _version2, _path);
  }
  /** Initialization */
  ...
  _babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2___default()(DocumentV1, [{
    ...
    get: function get() {
      ...
      return "".concat(workspace, "/").concat(type, "/").concat(name, "/").concat(version);
    }
    /** Document handlers */
...
_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(DocumentV2, "getDocs", function (_ref4) {
  var workspace = _ref4.workspace,
      scope = _ref4.scope,
      id = _ref4.id;

  var _scope = scope ? "/".concat(scope) : "";

  var _id = scope ? id ? "/".concat(id) : "" : "";

  var path = "v2/db/".concat(workspace).concat(_scope).concat(_id);
  return _Rest_Rest__WEBPACK_IMPORTED_MODULE_8__["default"].get({
    path: path
  });
});
...
RestBase.upload = function (_ref7) {
  ...
  var path = "v1/upload/".concat(packageName, "/");
...
RestBase.cloudFunction = function (_ref8) {
  ...
  var path = "v1/function/".concat(cbName, "/");
  var body = {
    func: func,
    args: args
  };

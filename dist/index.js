...
/* harmony import */ var _src_Database_Document__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./src/Database/Document */ "./src/Database/Document.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Document", function() { return _src_Database_Document__WEBPACK_IMPORTED_MODULE_12__["default"]; });

/* harmony import */ var _src_Database_Workspace__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./src/Database/Workspace */ "./src/Database/Workspace.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Workspace", function() { return _src_Database_Workspace__WEBPACK_IMPORTED_MODULE_13__["default"]; });

/* harmony import */ var _src_Database_Snapshot__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./src/Database/Snapshot */ "./src/Database/Snapshot.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Snapshot", function() { return _src_Database_Snapshot__WEBPACK_IMPORTED_MODULE_14__["default"]; });
...
/* harmony import */ var _Models_BaseModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Models/BaseModel */ "./src/Database/Models/BaseModel.js");
/* harmony import */ var _MasterDB__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./MasterDB */ "./src/Database/MasterDB.js");
/* harmony import */ var _Rest_Rest__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Rest/Rest */ "./src/Rest/Rest.js");
/* harmony import */ var _Snapshot__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Snapshot */ "./src/Database/Snapshot.js");
...
var Document = /*#__PURE__*/function () {
  function Document(_ref) {
    ...
    var _type2 = _ref.type,
        ...
        _apiVersion = _ref$apiVersion === void 0 ? "v1" : _ref$apiVersion;

    _babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, Document);

    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "_init", function (type, name, workspace, version, uri, apiVersion) {
      _this._parseArgs(workspace, type, name, version, uri);

      _this.subscriber = undefined;
      _this.database = _MasterDB__WEBPACK_IMPORTED_MODULE_5__["default"];
      _this.data = {};
      _this.apiVersion = apiVersion; //v1 || v2
    });
    ...
    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "read", function () {
      ...
      var paths = {
        v1: "v1/".concat(type, "/").concat(name, "/"),
        v2: "v2/db/".concat(workspace, "/").concat(type, "/").concat(name, "/").concat(version, "/")
      };
      var path = paths[apiVersion];
    ...
    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "resubscribe", function (callback) {
      ...
      _this.subscriber = new _Models_BaseModel__WEBPACK_IMPORTED_MODULE_4__["default"]({}, _this.type, _this.database, [{
        Scope: _this.type,
        Name: _this.name
      }]);
    ...
    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "createSnapshot", function (_ref2) {
      var trgWorkspace = _ref2.trgWorkspace,
          version = _ref2.version;
      var workspace = _this.workspace,
          type = _this.type,
          name = _this.name;
      return _Snapshot__WEBPACK_IMPORTED_MODULE_7__["default"].create({
    ...
    _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "getSnapShots", function () {
      var workspace = _this.workspace,
          type = _this.type,
          name = _this.name;
      return _Snapshot__WEBPACK_IMPORTED_MODULE_7__["default"].getAll({
        workspace: workspace,
        type: type,
        name: name
      });
    ...
    this._init(_type2, _name2, _workspace2, _version2, _uri, _apiVersion);
  }
  /** Initialization */


  _babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Document, [{
    key: "readOnly",
    ...
    value: function create(_ref3) {
      var type = _ref3.type,
          ...
          apiVersion = _ref3$apiVersion === void 0 ? "v1" : _ref3$apiVersion,
          workspace = _ref3.workspace;
      var paths = {
        v1: "v1/".concat(type, "/"),
        v2: "v2/db/".concat(workspace, "/").concat(type, "/").concat(name, "/")
      };
      var path = paths[apiVersion];
      var bodies = {
        v1: {
    ...
    value: function _delete(_ref4) {
      var type = _ref4.type,
          ...
          apiVersion = _ref4$apiVersion === void 0 ? "v1" : _ref4$apiVersion,
          _ref4$workspace = _ref4.workspace,
          workspace = _ref4$workspace === void 0 ? "global" : _ref4$workspace;
      var paths = {
        v1: "v1/".concat(type, "/").concat(name, "/"),
        v2: "v2/db/".concat(workspace, "/").concat(type, "/").concat(name, "/")
      };
...
var getToken = _Authentication_Authentication__WEBPACK_IMPORTED_MODULE_1__["default"].getToken;
var RestBase = {};
/**
 * Get headers with authorization token
 */

RestBase.getHeaders = function () {
  return {
    "Content-Type": "application/json",
    Authorization: "Bearer ".concat(getToken())
  };
...
RestBase._request = function (_ref2) {
  var path = _ref2.path,
      ...
      search = _ref2.search;
  var headers = RestBase.getHeaders();
...
var checkLogin = _Authentication_Authentication__WEBPACK_IMPORTED_MODULE_0__["default"].checkLogin,
  ...
  var handler = {
    ...
    __checkLogin: function __checkLogin(target, prop) {
      return checkLogin().then(function (res) {
        ...
        return Reflect.has(target, prop) ? Reflect.get(target, prop) : undefined;
      });
    },
    get: function get(target, prop) {
      return this.shouldCheckLogin.includes(prop) ? this.__checkLogin(target, prop) : Reflect.get(target, prop);
    }
  };

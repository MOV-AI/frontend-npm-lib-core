...
/*!******************!*\
  !*** ./index.js ***!
  \******************/
/*! exports provided: Authentication, Utils, Database, MasterDB, AuthWebSocket, Style, UndoManager, Clipboard, WSSub, User, BaseModel, DataManagerBase */
...
var User = function User() {
  ...
  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "getData", /*#__PURE__*/_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            name = _this.tokenData.message.name;
            url = "".concat(_this.baseUrl, "/").concat(name, "/");
  ...
  _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "isSuperUser", /*#__PURE__*/_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    var _data$response;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            data = _context2.sent;
            return _context2.abrupt("return", (data === null || data === void 0 ? void 0 : (_data$response = data.response) === null || _data$response === void 0 ? void 0 : _data$response.Superuser) || false);
...
Utils.flattenObject = function (obj) {
  ...
  return Object.keys(obj).reduce(function (acc, k) {
    ...
    if (_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_0___default()(obj[k]) === "object") Object.assign(acc, flattenObject(obj[k], pre + k));else acc[pre + k] = obj[k];
    return acc;
  }, {});
};
